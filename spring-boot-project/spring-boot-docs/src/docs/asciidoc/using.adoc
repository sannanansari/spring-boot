...
If you are starting out with Spring Boot, you should probably read the _xref:getting-started.adoc#getting-started[Getting Started]_ guide before diving into this section.
