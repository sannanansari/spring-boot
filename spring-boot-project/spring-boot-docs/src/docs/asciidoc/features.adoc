...
If you have not already done so, you might want to read the  "xref:getting-started.adoc#getting-started[Getting Started]" and "xref:using#using[Developing with Spring Boot]" sections, so that you have a good grounding of the basics.
